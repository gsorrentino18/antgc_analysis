...
ddf_trainx = dask.dataframe.from_pandas(trainDFx, npartitions=8)
ddf_trainy = dask.dataframe.from_pandas(trainDFy, npartitions=8)
ddf_trainw = dask.dataframe.from_pandas(trainDFw, npartitions=8)

del ddf_trainx
del ddf_trainy
del ddf_trainw

ddf_validationx = dask.dataframe.from_pandas(validationDFx, npartitions=8)
ddf_validationy = dask.dataframe.from_pandas(validationDFy, npartitions=8)
ddf_validationw = dask.dataframe.from_pandas(validationDFw, npartitions=8)

del ddf_validationx
del ddf_validationy
del ddf_validationw

ddf_testx = dask.dataframe.from_pandas(testDFx, npartitions=8)
ddf_testy = dask.dataframe.from_pandas(testDFy, npartitions=8)
ddf_testw = dask.dataframe.from_pandas(testDFw, npartitions=8)
