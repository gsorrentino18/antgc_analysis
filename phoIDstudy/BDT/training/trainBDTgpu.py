...
parser.add_argument('--saveDir', type=str, default='../optimizedV0/',
...
for iChunk in range(nChunks):
	...
	phoModelIterated = xg.train(params, dtrain=trainPho, evals=watchlist, evals_result=accuracyProgress, early_stopping_rounds=10, verbose_eval=True, num_boost_round=100000, xgb_model=phoModelIterated)
