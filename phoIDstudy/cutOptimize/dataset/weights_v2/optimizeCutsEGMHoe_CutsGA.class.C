...
NVar 5
bdtScore                      bdtScore                      bdtScore                      BDT Score                                                       'F'    [3.25863283024e-07,0.998596489429]
phoHoverE                     phoHoverE                     phoHoverE                     H/E                                                             'F'    [0,0.0999991223216]
phoPFClusEcalIsoCorr          phoPFClusEcalIsoCorr          phoPFClusEcalIsoCorr          I_{ECAL}^{PFClus}             GeV                               'F'    [-12.9982624054,14.9998626709]
phoPFClusHcalIsoCor           phoPFClusHcalIsoCor           phoPFClusHcalIsoCor           I_{HCAL}^{PFClus}             GeV                               'F'    [-166.515106201,49.9999847412]
phoTrkSumPtHollowConeDR03Corr phoTrkSumPtHollowConeDR03Corr phoTrkSumPtHollowConeDR03Corr I_{TkrH}                      GeV                               'F'    [-10.1106100082,9.99999523163]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 5 )
   {
      ...
      const char* inputVars[] = { "bdtScore", "phoHoverE", "phoPFClusEcalIsoCorr", "phoPFClusHcalIsoCor", "phoTrkSumPtHollowConeDR03Corr" };
