...
NVar 5
bdtV2Score                    bdtV2Score                    bdtV2Score                    BDT Score                                                       'F'    [1.88435578252e-07,0.999977231026]
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 5 )
   {
      ...
      const char* inputVars[] = { "bdtV2Score", "phoHoverE", "phoPFECALClusIsoCorr", "phoPFHCALClusIsoCorr", "phoTkrIsoCorr" };
