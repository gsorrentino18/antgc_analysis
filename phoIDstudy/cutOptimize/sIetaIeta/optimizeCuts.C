...
void optimizeCuts(){
	...
	factory.BookMethod(&dataloader, TMVA::Types::kCuts, "CutsGA", "H:!V:VarProp[0]=FMin:VarProp[1]=FMin:VarProp[2]=FMin:VarProp[3]=FMin:VarProp[4]=FMin:FitMethod=GA:EffSel:PopSize=600:Steps=50:Cycles=3:SC_steps=10:SC_rate=5:SC_factor=0.95");
