...
Dir            : /data/cmszfs1/user/wadud/aNTGCmet/aNTGC_analysis/phoIDstudy/cutOptimize/sIetaIeta2
...
NVar 5
phoSigmaIEtaIEta              phoSigmaIEtaIEta              phoSigmaIEtaIEta              #sigma_{i#etai#eta}                                             'F'    [0.000145970989252,0.0241710785776]
phoHoverE                     phoHoverE                     phoHoverE                     H/E                                                             'F'    [0,0.0499966666102]
phoPFClusEcalIsoCorr          phoPFClusEcalIsoCorr          phoPFClusEcalIsoCorr          I_{ECAL}^{PFClus}             GeV                               'F'    [-12.9982624054,9.99998283386]
phoPFClusHcalIsoCor           phoPFClusHcalIsoCor           phoPFClusHcalIsoCor           I_{HCAL}^{PFClus}             GeV                               'F'    [-166.515106201,19.9999332428]
phoTrkSumPtHollowConeDR03Corr phoTrkSumPtHollowConeDR03Corr phoTrkSumPtHollowConeDR03Corr I_{TkrH}                      GeV                               'F'    [-10.1106100082,7.99961614609]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 5 )
   {
      ...
      const char* inputVars[] = { "phoSigmaIEtaIEta", "phoHoverE", "phoPFClusEcalIsoCorr", "phoPFClusHcalIsoCor", "phoTrkSumPtHollowConeDR03Corr" };
