		...
		if(isMC) {
		   ...
		   break;
                ...
                for(Int_t i = 0; i < _nTau; i++){
                     ...
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 4)) continue; //byVVVLooseDeepTau2017v2p1VSjet
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 12)) continue; //byVVVLooseDeepTau2017v2p1VSe
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 18)) continue; //byVLooseDeepTau2017v2p1VSmu
