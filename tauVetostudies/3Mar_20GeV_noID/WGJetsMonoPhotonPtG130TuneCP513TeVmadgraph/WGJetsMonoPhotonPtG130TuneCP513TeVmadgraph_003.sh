...
echo "Begin script..."
root -b -q /data/cmszfs1/user/gsorrent/antgc_analysis/tauVetostudies/3Mar_20GeV_noID//WGJetsMonoPhotonPtG130TuneCP513TeVmadgraph//WGJetsMonoPhotonPtG130TuneCP513TeVmadgraph_003.C
echo "End script!"
