		...
		if(isMC) {
		   ...
		   break;
                ...
                for(Int_t i = 0; i < _nTau; i++){
                     ...
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 2)) continue; //byVVVLooseDeepTau2017v2p1VSjet
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 10)) continue; //byVVVLooseDeepTau2017v2p1VSe
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 16)) continue; //byVLooseDeepTau2017v2p1VSmu
