		...
		if(isMC) {
		   ...
		   break;
                ...
                for(Int_t i = 0; i < _nTau; i++){
                     ...
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 0)) continue; //byVVVLooseDeepTau2017v2p1VSjet
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 8)) continue; //byVVVLooseDeepTau2017v2p1VSe
