		...
		if(isMC) {
		   ...
		   break;
                ...
                for(Int_t i = 0; i < _nTau; i++){
                     ...
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 5)) continue; //byVVVLooseDeepTau2017v2p1VSjet
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 13)) continue; //byVVVLooseDeepTau2017v2p1VSe
                     if(!getBit(tmptauIDbitsDeepTau2017v2p1, 19)) continue; //byVLooseDeepTau2017v2p1VSmu
