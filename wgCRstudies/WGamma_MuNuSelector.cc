...
#ifndef WGAMMAMUNUSELECTOR
#define WGAMMAMUNUSELECTOR
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class WGamma_MuNuSelector {
  public:
	WGamma_MuNuSelector(std::string FILELIST, std::string OUTFILE, Float_t XSECTION = -1., std::string MCPILEUPHIST = "", std::string DATAPILEUPHIST = "/hdfs/cms/user/wadud/anTGC/analysis_data/METv5_pileup/pileup_2017_data.root",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
WGamma_MuNuSelector::WGamma_MuNuSelector(std::string FILELIST, std::string OUTFILE, Float_t XSECTION, std::string MCPILEUPHIST, std::string DATAPILEUPHIST,
	...
	std::cout << "*************************************************************************************************************************************************" << std::endl <<
	          ...
	          "Running WGamma_MuNuSelector" << std::endl <<
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t				WGamma_MuNuSelector::nearestFinalGen(Float_t _eta, Float_t _phi, Float_t _deltaRmax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t				WGamma_MuNuSelector::nearestFinalGen(Short_t _phoIndex, Float_t _deltaRmax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNuSelector::photonIsPrompt(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNuSelector::matchWithRecoPho(Short_t _genIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNuSelector::matchWithTrigPho(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
	Float_t minDeltaR = 999.;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNuSelector::photonIsFake(Short_t _phoIndex, Float_t _deltaRmax) {
...
Bool_t  WGamma_MuNuSelector::phoIsSigCandidate(Short_t _phoIndex) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNuSelector::selectEvent() {
	...
	Bool_t 	passedHoE = 0;
	Bool_t 	passedECALiso = 0;
	Bool_t 	passedHCALiso = 0;
	Bool_t 	passedTkrIso = 0;
	Bool_t 	passedBDT = 0;
	...
	for (UShort_t iPho = 0; iPho < _nPho; iPho++) {
           ...
           if(_phoHoverE[iPho] > 0.0326) continue;
           if(_phoSigmaIEtaIEtaFull5x5[iPho] > 0.0272) continue;
	...
	if (passedECALiso) registerAllCutFlow();
	if (passedHCALiso) registerAllCutFlow();
	if (passedTkrIso) registerAllCutFlow();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNuSelector::initEventTypes() {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNuSelector::analyze() {
	std::cout << "--------------------------------------------------------------------------------------------------" << std::endl <<
	          getCurrentTime() << std::endl <<
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Float_t 	WGamma_MuNuSelector::getPhoBDTScore(Short_t iPho) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Char_t WGamma_MuNuSelector::fillVars(Short_t _phoIndex, Short_t _muIndex) {
	...
	for (Int_t i = 0; i < (_nTau); i++) {
		...
		if (std::abs(_tauEta[i]) > 2.3) continue;
                if (_tauDMs[i][2]==0) continue;  //decayModeFindingNEW
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNuSelector::initNtuples(std::string FILELIST) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNuSelector::initEventType(eventType & evType, std::string typeName, std::string typeTitle) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNuSelector::fillEventType(eventType & evType) {
	evType.tree->Fill();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNuSelector::registerAllCutFlow() {
...
void WGamma_MuNuSelector::registerCutFlow(eventType & evType) {
