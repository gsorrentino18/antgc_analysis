...
#ifndef WGAMMAMUNUJETFAKESDENOMSELECTOR
#define WGAMMAMUNUJETFAKESDENOMSELECTOR
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class WGamma_MuNu_JetFakesDenomSelector {
  public:
	WGamma_MuNu_JetFakesDenomSelector(std::string FILELIST, std::string OUTFILE, Float_t XSECTION = -1., std::string MCPILEUPHIST = "", std::string DATAPILEUPHIST = "/hdfs/cms/user/wadud/anTGC/analysis_data/METv5_pileup/pileup_2017_data.root",
	...
	~WGamma_MuNu_JetFakesDenomSelector() {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
WGamma_MuNu_JetFakesDenomSelector::WGamma_MuNu_JetFakesDenomSelector(std::string FILELIST, std::string OUTFILE, Float_t XSECTION, std::string MCPILEUPHIST, std::string DATAPILEUPHIST,
        ...
        std::string BDT_PATH, std::string PFPHOISO_EFFECTIVE_AREAS, std::string PFNEUISO_EFFECTIVE_AREAS, std::string PFCHISO_EFFECTIVE_AREAS ) {

	std::cout << "*************************************************************************************************************************************************" << std::endl <<
	          getCurrentTime() << std::endl <<
	          "Running WGamma_MuNu_JetFakesDenomSelector" << std::endl <<
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t				WGamma_MuNu_JetFakesDenomSelector::nearestFinalGen(Float_t _eta, Float_t _phi, Float_t _deltaRmax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t				WGamma_MuNu_JetFakesDenomSelector::nearestFinalGen(Short_t _phoIndex, Float_t _deltaRmax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNu_JetFakesDenomSelector::photonIsPrompt(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNu_JetFakesDenomSelector::matchWithRecoPho(Short_t _genIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	WGamma_MuNu_JetFakesDenomSelector::matchWithTrigPho(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax) {
	Float_t minDeltaR = 999.;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNu_JetFakesDenomSelector::photonIsFake(Short_t _phoIndex, Float_t _deltaRmax) {
...
Bool_t  WGamma_MuNu_JetFakesDenomSelector::phoIsSigCandidate(Short_t _phoIndex) {
        ...
        std::cout << "phoIsSigCandidate" << std::endl;
        return 1;
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNu_JetFakesDenomSelector::selectEvent() {
	...
	for (UShort_t iPho = 0; iPho < _nPho; iPho++) {
        ...
        for(UShort_t iMu=0; iMu<_nMu; iMu++) {
           if (_muPt[iMu] < 30.) continue;
           if (std::abs(_muEta[iMu]) > 2.5) continue;
        ...
        if (TightMu != 1) return 0; // veto evts with 0 or more than 1 tight muon          
        if (iMuon >=0) foundMu = true;
        if (!foundMu) return 0;
	...
	if (getBit((_phoQualityBits[highetsPtIndex]), 0)) return 0;
	registerAllCutFlow();

	if (_phoMIPTotEnergy[highetsPtIndex] > 4.9) return 0;
	registerAllCutFlow();
	...
	for (Int_t iMu = 0; iMu < (_nMu); iMu++) {
		if (_muPt[iMu] < 30.) continue;
		if (std::abs(_muEta[iMu]) > 2.5) continue;
		if (!getBit((_muIDbit[iMu]), 3)) continue; 		// 3=tight
		if (!getBit((_muIDbit[iMu]), 9)) continue; 		// 9=tightIso
		nMu++;
	...
	if (highetsPtMuIndex < 0) return 0;
	registerAllCutFlow();

	if (nMu > 1) return 0;
	registerAllCutFlow();*/

	fillVars(iPhoton, iMuon);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNu_JetFakesDenomSelector::initEventTypes() {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNu_JetFakesDenomSelector::analyze() {
	std::cout << "--------------------------------------------------------------------------------------------------" << std::endl <<
	          getCurrentTime() << std::endl <<
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Float_t 	WGamma_MuNu_JetFakesDenomSelector::getPhoBDTScore(Short_t iPho) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Char_t WGamma_MuNu_JetFakesDenomSelector::fillVars(Short_t _phoIndex, Short_t _muIndex) {
	...
	for (Int_t i = 0; i < _nEle; i++) {
		...
		// Loose ID
		if (!getBit((_eleIDbit[i]), 1)) continue;
		setBit(lepVeto_,0,1);
		break;
	}

	for (Int_t i = 0; i < (_nMu); i++) {
		if (i == _muIndex) continue;
		if ((_muPt[i]) < 10.) continue;
		if (std::abs(_muEta[i]) > 2.5) continue;
	...
	for (Int_t i = 0; i < (_nTau); i++) {
		...
		if (std::abs(_tauEta[i]) > 2.4) continue;
	...
	lepPt_			=	_muPt[_muIndex];
	lepEta_ 			=	_muEta[_muIndex];
	lepPhi_			=	_muPhi[_muIndex];
	mTLepMet_			=	std::sqrt(2. * _muPt[_muIndex] * _pfMET * (1. - std::cos(deltaPhi(_muPhi[_muIndex], _pfMETPhi))));

	lepGenPID_ 		=	-999;
	if (isMC) {
		Short_t 	iGenLep 		= nearestFinalGen(_muEta[_muIndex], _muPhi[_muIndex], 0.1);
		if (iGenLep > -1) lepGenPID_ 					=  _mcPID[iGenLep];
	}

	Float_t 		lepMetRecoilPx 			=	_pfMET * std::cos(_pfMETPhi) + _muPt[_muIndex] * std::cos(_muPhi[_muIndex]);
	Float_t 		lepMetRecoilPy 			=	_pfMET * std::sin(_pfMETPhi) + _muPt[_muIndex] * std::sin(_muPhi[_muIndex]);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t WGamma_MuNu_JetFakesDenomSelector::initNtuples(std::string FILELIST) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNu_JetFakesDenomSelector::initEventType(eventType & evType, std::string typeName, std::string typeTitle) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNu_JetFakesDenomSelector::fillEventType(eventType & evType) {
	evType.tree->Fill();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void WGamma_MuNu_JetFakesDenomSelector::registerAllCutFlow() {
...
void WGamma_MuNu_JetFakesDenomSelector::registerCutFlow(eventType & evType) {
	evType.cutFlowCount->Fill(evType.lastCutStep);
	evType.cutFlowGenWeight->Fill(evType.lastCutStep, genWeight_);
	evType.lastCutStep = evType.lastCutStep + 1.01;
};
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#endif
