...
className="denomFinder"
ccfilepath="/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/jetFakes/denomFinder.cc"

# className="numFinder"
# ccfilepath="/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/jetFakes/numFinder.cc"


# className="sidebandFinder"
# ccfilepath="/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/jetFakes/sidebandFinder.cc"
