...
class denomFinder{
public:
	denomFinder(std::string FILELIST, std::string OUTFILE, Float_t XSECTION=-1., std::string MCPILEUPHIST="", std::string DATAPILEUPHIST="/hdfs/cms/user/wadud/anTGC/analysis_data/METv5_pileup/pileup_2017_data.root",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
denomFinder::denomFinder(std::string FILELIST, std::string OUTFILE, Float_t XSECTION, std::string MCPILEUPHIST, std::string DATAPILEUPHIST,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	denomFinder::photonIsPrompt(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	denomFinder::matchWithRecoPho(Short_t _genIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	denomFinder::matchWithTrigPho(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
	Float_t minDeltaR = 999.;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t denomFinder::photonIsFake(Short_t _phoIndex, Float_t _deltaRmax){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t denomFinder::selectEvent(){
	...
	for(UShort_t iPho = 0; iPho < _nPho; iPho++){
		...
		Float_t iPhoAbsSCEta = std::abs(_ecalSCeta[_phoDirectEcalSCindex[iPho]]);

		if( iPhoAbsSCEta > BETRetaMin) continue;
		passedFidCut = 1;

		Float_t iPhoPt = _phoCalibEt[iPho];

		if(iPhoPt < 200.) continue;
		passedPtCut 	=	1;

		if(_phoHoverE[iPho] > 3.1972081872819871e-02) continue;

		UChar_t iQualityBits = _phoQualityBits[iPho];
		if(getBit(iQualityBits,0)) continue;                             	// 0=has pixel seed, 1=electron veto
		passedPixelCut = 1;

		Float_t iPhoPFECALClusIsoCorr 		= 	_phoPFClusEcalIso[iPho] - _rho * PFECALClusEffAreas.getEffectiveArea(iPhoAbsSCEta) - PFECALClusPtScaling.getPtScaling(iPhoAbsSCEta, iPhoAbsSCEta);
		Float_t iPhoPFHCALClusIsoCorr 		= 	_phoPFClusHcalIso[iPho] - _rho * PFHCALClusEffAreas.getEffectiveArea(iPhoAbsSCEta) - PFHCALClusPtScaling.getPtScaling(iPhoAbsSCEta, iPhoAbsSCEta);
		Float_t iPhoTkrIsoCorr 				= 	_phoTrkSumPtHollowConeDR03[iPho] - _rho * TkrEffAreas.getEffectiveArea(iPhoAbsSCEta);

		Bool_t passECALiso = (iPhoPFECALClusIsoCorr < 5.5702003247919532e+00);
		Bool_t passHCALiso = (iPhoPFHCALClusIsoCorr < 1.5870381409324537e+01);
		Bool_t passTkrIso = (iPhoTkrIsoCorr < 3.9988330612434098e+00);

		if(passECALiso && passHCALiso && passTkrIso) continue;

		Bool_t passVLooseECALiso = (iPhoPFECALClusIsoCorr < 3. * 5.5702003247919532e+00);
		Bool_t passVLooseHCALiso = (iPhoPFHCALClusIsoCorr < 3. * 1.5870381409324537e+01);
		Bool_t passVLooseTkrIso = (iPhoTkrIsoCorr < 3. * 3.9988330612434098e+00);

		if(!passVLooseECALiso || !passVLooseHCALiso || !passVLooseTkrIso) continue;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t denomFinder::initEventTypes(){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Char_t denomFinder::fillPhoVars(Short_t _phoIndex){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t denomFinder::initNtuples(std::string FILELIST){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void denomFinder::initEventType(eventType & evType, std::string typeName, std::string typeTitle){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void denomFinder::fillEventType(eventType & evType){
	evType.tree->Fill();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void denomFinder::registerAllCutFlow(){
...
void denomFinder::registerCutFlow(eventType & evType){
