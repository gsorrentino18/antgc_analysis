	...
	while(inputTTreeReader.Next()){
		...
		if(isMC) {
		   ...
		   break;
               ...
               Float_t a1_MC = 0.0750343;
               Float_t a2_MC = -0.0321334;
               Float_t a3_MC = 0.00320567;
               ...
               for(UShort_t iPho=0; iPho<_nPho; iPho++){
                  ...
                  if (isMC) {
                     FRweight_ = a1_MC + a2_MC*fabs(_phoEta[iPhoton]) + a3_MC*fabs(_phoEta[iPhoton])*fabs(_phoEta[iPhoton]);
                  }
               }
