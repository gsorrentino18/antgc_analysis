...
Bool_t egammafakeValidation::photonPassingID(UShort_t phoIndex){
        ...
        assert(out_len == 1);
        XGDMatrixFree(dTest);
        phoBDTpredIn_ = prediction[0];

        pass95_ = (phoBDTpredIn_ >= 4.9013550283797025e-01) && (phoHoverE < 4.2132449148158196e-02) && (phoPFECALClusIsoCorr < 5.1143879813442599e+00) && (phoPFHCALClusIsoCorr < 1.7020221456277284e+01) && (phoTkrIsoCorr < 3.5001887785563284e+00);
		   ...
		   break;
               ...
               if(isMC) {
                  ...
                  for(UShort_t iPho=0; iPho<_nPho; iPho++){
                     ...
                     if (fabs(_phoEta[iPho]) > 1.442) continue;
