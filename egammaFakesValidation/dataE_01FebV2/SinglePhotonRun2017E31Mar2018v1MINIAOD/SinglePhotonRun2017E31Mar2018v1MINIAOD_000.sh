...
echo "Begin script..."
root -b -q /data/cmszfs1/user/gsorrent/antgc_analysis/egammaFakesValidation/dataE_01FebV2//SinglePhotonRun2017E31Mar2018v1MINIAOD//SinglePhotonRun2017E31Mar2018v1MINIAOD_000.C
echo "End script!"
