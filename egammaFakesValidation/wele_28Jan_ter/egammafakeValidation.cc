...
#ifndef EGAMMAFAKEVALIDATION
#define EGAMMAFAKEVALIDATION
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class egammafakeValidation{
public:
	egammafakeValidation(std::string FILELIST, std::string OUTFILE, Float_t XSECTION=-1., std::string MCPILEUPHIST="", std::string DATAPILEUPHIST="/hdfs/cms/user/wadud/anTGC/analysis_data/METv5_pileup/pileup_2017_data.root",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
egammafakeValidation::egammafakeValidation(std::string FILELIST, std::string OUTFILE, Float_t XSECTION, std::string MCPILEUPHIST, std::string DATAPILEUPHIST, //std::string HoE_EFFECTIVE_AREAS, 
std::string PFECALCLUS_EFFECTIVE_AREAS, std::string PFHCALCLUS_EFFECTIVE_AREAS, std::string TKRISO_EFFECTIVE_AREAS,
	...
	"Running egammafakeValidation"<<std::endl<<
...
/*Bool_t egammafakeValidation::photonPassingID(UShort_t phoIndex){
        ...
        phoPt_                  = _phoCalibEt[phoIndex];

        phoR9Full5x5_           = _phoR9Full5x5[phoIndex];
        phoS4Full5x5_           = _phoE2x2Full5x5[phoIndex]/_ecalSCRawEn[phoSCindex];
        phoEmaxOESCrFull5x5_    = _phoMaxEnergyXtal[phoIndex]/_ecalSCRawEn[phoSCindex];
        phoE2ndOESCrFull5x5_    = _phoE2ndFull5x5[phoIndex]/_ecalSCRawEn[phoSCindex];
        phoE2ndOEmaxFull5x5_    = _phoE2ndFull5x5[phoIndex]/_phoMaxEnergyXtal[phoIndex];
        phoE1x3OESCrFull5x5_    = _phoE1x3Full5x5[phoIndex]/_ecalSCRawEn[phoSCindex];
        phoE2x5OESCrFull5x5_    = _phoE2x5Full5x5[phoIndex]/_ecalSCRawEn[phoSCindex];
        phoE5x5OESCrFull5x5_    = _phoE5x5Full5x5[phoIndex]/_ecalSCRawEn[phoSCindex];

        phoSigmaIEtaIEta_       = _phoSigmaIEtaIEtaFull5x5[phoIndex];
        phoSigmaIEtaIPhi_       = _phoSigmaIEtaIPhiFull5x5[phoIndex];
        phoSigmaIPhiIPhi_       = _phoSigmaIPhiIPhiFull5x5[phoIndex];

        phoE2x2Full5x5_         = _phoE2x2Full5x5[phoIndex];
        phoE3x3Full5x5_         = phoR9Full5x5_ * _ecalSCRawEn[phoSCindex];
        phoE5x5Full5x5_         = _phoE5x5Full5x5[phoIndex];
        phoMaxEnergyXtal_       = _phoMaxEnergyXtal[phoIndex];
        phoE2ndFull5x5_         = _phoE2ndFull5x5[phoIndex];
        phoE1x3Full5x5_         = _phoE1x3Full5x5[phoIndex];
        phoE1x5Full5x5_         = _phoE1x5Full5x5[phoIndex];
        phoE2x5Full5x5_         = _phoE2x2Full5x5[phoIndex];
        ...
        phoPFClusEcalIso_               = _phoPFClusEcalIso[phoIndex];
        phoPFClusHcalIso_               = _phoPFClusHcalIso[phoIndex];
        phoTrkSumPtHollowConeDR03_      = _phoTrkSumPtHollowConeDR03[phoIndex];
        phoECALIso_                     = _phoECALIso[phoIndex];
        phoHCALIso_                     = _phoHCALIso[phoIndex];
        ...
        phoHoverE_              = _phoHoverE[phoIndex];
        phoEtaWOPhiWFull5x5_    = phoEtaWidth_/phoPhiWidth_;

        //if(predictBDT){
           std::cout << "calcoliamo il BDT..." << std::endl;

           std::vector<Float_t> feats{pho2x2OE3x3Full5x5_, phoE1x3OESCrFull5x5_, phoE2ndOESCrFull5x5_, phoE2x5OESCrFull5x5_, phoEmaxOESCrFull5x5_, phoEtaWOPhiWFull5x5_, phoEtaWidth_, phoPhiWidth_, phoR9Full5x5_, phoS4Full5x5_, phoSieieOSipipFull5x5_, phoSigmaIEtaIEta_, phoSigmaIEtaIPhi_, phoSigmaIPhiIPhi_};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t egammafakeValidation::selectEvent(){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t egammafakeValidation::initEventTypes(){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void egammafakeValidation::analyze(){
	std::cout<<"--------------------------------------------------------------------------------------------------"<<std::endl<<
	getCurrentTime()<<std::endl<<
	...
	while(inputTTreeReader.Next()){
		...
		if(current_entry % REPORT_EVERY == 0){
			...
			",\t\tevent\t"<<(_event)<<"\t\tFile " <<inputTree->GetCurrentFile()->GetName() <<std::endl;
                ...
                if (_nEle != 1) continue; //exactly one electron in the event
		...
		if(isMC) {
                        ...
                        Double_t lumi = 41.56;
                        //DY norm
                        Double_t norm100to200 = 93.66 * 1000. * lumi / 2227117.;
                        Double_t norm200to400 = 4.135 * 1000. * lumi / 686444.;
                        Double_t norm400to800 = 0.2457 * 1000. * lumi / 950278.;
                        Double_t norm800to2000 = 0.009936 * 1000. * lumi / 757960.;
                        //QCD norm
                        Double_t normQCD200to300 = 1554000.* 1000. * lumi /59360369.;
                        Double_t normQCD300to500 = 323400.* 1000. * lumi /59459614.;
                        Double_t normQCD500to700 = 30040.* 1000. * lumi /56041018.;
                        Double_t normQCD700to1000 = 6353.* 1000. * lumi /47518924.;
                        Double_t normQCD1000to1500 = 1095.* 1000. * lumi /16530204.;
                        Double_t normQCD1500to2000 = 99.13* 1000. * lumi /11508604.;
                        Double_t normQCD2000toInf = 20.19* 1000. * lumi /5825566.;
                        //WGJets norm
                        Double_t normWGj = 0.7158 * 1000. * lumi /4903944;
                        //WGtoLnu norm
                        Double_t normWGtoLnu = 1.126 * 1000. * lumi /3734874.89886734075844287872;
                        //GJets norm
                        Double_t normGj200to400 = 2193. * 1000. * lumi /10224007.;
                        Double_t normGj400to600 = 258.3 * 1000. * lumi /4640128.;
                        Double_t normGj600toInf = 85.23* 1000. * lumi /3278039.;
                        //TGjets, TTGjets norm
                        //Double_t normTGjets = 3.055 * 1000. * lumi /5919452.74006462097167968750;
                        Double_t normTTGjets = 4.115* 1000. * lumi /52378711.10348129272460937500;
                        //WW norm
                        Double_t normWW = 75.9 * 1000. * lumi /7765891.02026236057281494141;
                        //WZ norm
                        Double_t normWZ = 27.57 * 1000. * lumi /3928630.;
                        //ZZ norm
                        Double_t normZZ = 12.14 * 1000. * lumi /1925931.;
                        //Wlepton norm
                        Double_t normWele = 174.* 1000. * lumi /1916817.;
                        Double_t normWmuo = 174.2* 1000. * lumi /1905408.;
                        Double_t normWtau = 174.* 1000. * lumi /1000000.;
			if(doPUreweight){
				genWeight_ = _genWeight;
				puWeight_ = puReweighter.weight(_puTrue) * genWeight_ * normWele; //puWeight + MC norm + genWeight
		   ...
		   break;
               ...
               Float_t a1 = 0.0470368;
               Float_t a2 = 0.00999998;
               Float_t a3 = -0.0225408;
               ...
               if(isMC) {
                  ...
                  for(UShort_t iPho=0; iPho<_nPho; iPho++){
                     ...
                     if (phoPixVeto == 1 ) continue;
                     if (fabs(_phoEta[iPho]) > 1.4) continue;
                     if (photonPassingID(iPho) == 1 ) continue;
                     iPhoton = iPho;
                  }
                  if (iPhoton >=0) foundPho = true;

               } else {  //selection for data
                  if (getBit(lepVeto_,1)) continue; //muon veto
                  ...
                  for(UShort_t iPho=0; iPho<_nPho; iPho++){
                     ...
                     deltaPhi_ = fabs(_elePhi[0] - _phoPhi[iPho]);
                     if (deltaPhi_ > acos(-1)) {
                        deltaPhi_ = 2*acos(-1) - deltaPhi_;
                     }
                     deltaEta_ = _eleEta[0] - _phoEta[iPho];
                     deltaPt_ = _eleCalibPt[0] - _phoCalibEt[iPho]; 
                     deltaR_ = sqrt((deltaPhi_*deltaPhi_) + (deltaEta_*deltaEta_));

                     if (deltaR_ > 0.2) continue;
                     UChar_t phoPixVeto = _phoQualityBits[iPho];
                     if (phoPixVeto == 0 ) continue;
                     if (fabs(_phoEta[iPho]) > 1.4) continue;
                     if (photonPassingID(iPho) == 0 ) continue;
                     iPhoton = iPho;
                     FRweight_ = a1 + a2*fabs(_phoEta[iPhoton]) + a3*fabs(_phoEta[iPhoton])*fabs(_phoEta[iPhoton]);
                  }
                  if (iPhoton >=0) foundPho = true;
               }

               if (foundPho) {
                  std::cout << "definiamo le quantità per il fotone trovato..." << std::endl;
               ...
               if (foundPho) {
                  cout << "test4" << endl;
                  /*if (!isMC) {
                     std::cout << "calcoliamo il FR..." << std::endl;
                     Float_t a1 = 0.0470368;
                     Float_t a2 = 0.00999998;
                     Float_t a3 = -0.0225408;
                     FRweight_ = a1 + a2*fabs(phoEta_) + a3*fabs(phoEta_)*fabs(phoEta_);
                  }*/
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t egammafakeValidation::initNtuples(std::string FILELIST){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void egammafakeValidation::initEventType(eventType & evType, std::string typeName, std::string typeTitle){
	...
	evType.tree->Branch("minDeltaRPhoJet30", &minDeltaRPhoJet30_);
        ...
        evType.tree->Branch("FRweight", &FRweight_);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void egammafakeValidation::fillEventType(eventType & evType){
	evType.tree->Fill();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void egammafakeValidation::registerAllCutFlow(){
...
void egammafakeValidation::registerCutFlow(eventType & evType){
