...
jobListFile=/local/cms/user/gsorrent/antgc_analysis/egammaFakesValidation/batch/jobListGiulia.txt
...
#ccfilepath="/local/cms/user/gsorrent/antgc_analysis/phoIDstudy/fakePhoFinderV2.cc"


#className="genPhoMatcher"
#ccfilepath="/local/cms/user/gsorrent/antgc_analysis/phoIDstudy/genPhoMatcherV6.cc"

className="egammafakeValidation"
ccfilepath="/local/cms/user/gsorrent/antgc_analysis/egammaFakesValidation/egammafakeValidationV2.cc"
